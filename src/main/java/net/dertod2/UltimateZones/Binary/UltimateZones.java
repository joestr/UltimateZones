...
public class UltimateZones extends JavaPlugin {
	...
	public void onEnable() {
		...
		if (UltimateZones.isDynmapInstalled) {
			UltimateUtils.notify("Plugin detected installed " + ChatColor.GOLD + "dynmap" + ChatColor.DARK_GREEN + ". Activated support!");
			new DynmapHandler();
		}
		...
		if (Updater.autoCheck) UltimateZones.updater.check(Bukkit.getConsoleSender());
	}

	public void onDisable() {
		if (UltimateZones.presetControl != null) UltimateZones.presetControl = null;
		if (UltimateZones.rightControl != null) UltimateZones.rightControl = null;
		if (UltimateZones.zoneControl != null) UltimateZones.zoneControl = null;
