...
public class ZoneSchema extends TableEntry {
    ...
    public AbstractZone toZone() {
        ...
        case EXTENDED:
            return new ExtendedZone(this.id, this.libZoneId, this.zoneSynonym, this.flagList, this.breakList,
                    this.placeList, this.parentId);
        case INDEPENDENT:
            return new IndependentZone(this.id, this.libZoneId, this.zoneSynonym, this.flagList, this.breakList,
                    this.placeList, this.parentId);
        case MAIN:
            return new MainZone(this.id, this.libZoneId, this.zoneSynonym, this.flagList, this.breakList,
                    this.placeList, UUID.fromString(this.owner), this.priority);
        default:
            return null;
        }
    }
