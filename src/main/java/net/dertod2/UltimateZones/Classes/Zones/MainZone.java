...
public class MainZone extends AbstractZone {
    ...
    public MainZone(int zoneId, int libZoneId, String synonym, List<Integer> flagList, List<String> breakList,
            List<String> placeList, UUID player, int zonePriority) {
    ...
    public OfflinePlayer getPlayer() {
        ...
        if (offlinePlayer == null)
            offlinePlayer = NMSHelper.lookupPlayer(this.player);
