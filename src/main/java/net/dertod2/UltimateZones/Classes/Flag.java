...
public enum Flag {
	...
	BreakVehicles(13, "BreakVehicles"), // Abbauen von Booten/Loren (eigene gesetzte, wenn erlaubt, können trozdem abgebaut werden -Idee-) -fin-
	...
	// Special
	PickupItems(17, false, false, "PickupItems"), // Aufnehmen von Items die auf dem Boden liegen (eigene weggeworfene können weiter aufgehoben werden) -fin-
