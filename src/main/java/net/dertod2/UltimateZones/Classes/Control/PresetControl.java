...
public class PresetControl {
	...
	public void load() {
		...
		if (this.presetList == null) this.presetList = new HashMap<String, Preset>();
	...
	public Preset createPreset(String presetName, List<Integer> flagList, List<String> breakList, List<String> placeList) {
		if (this.presetList.containsKey(presetName.toLowerCase())) return null;
