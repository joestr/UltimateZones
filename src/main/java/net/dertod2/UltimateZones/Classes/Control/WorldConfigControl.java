    ...
    public void loadWorld(World world) {
        ...
        if (!file.exists()) {
            try {
                ...
                UltimateUtils
                        .error("Error while saving default world config for World " + ChatColor.GOLD + world.getName());
            } finally {
                UltimateUtils.notify(ChatColor.DARK_GREEN + "Saved world configuration for world " + ChatColor.GOLD
                        + world.getName());
            }
        }
