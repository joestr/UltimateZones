...
public class Preset extends TableEntry implements IRights {
    ...
    public static Preset createPreset(String presetName, List<Integer> flagList, List<String> breakList,
    ...
    public static Preset createPreset(String presetName, RightReference rightReference) {
        return UltimateZones.presetControl.createPreset(presetName, rightReference.getPlainFlagList(),
                rightReference.getPlainBreakList(), rightReference.getPlainPlaceList());
    }

    public static Preset createPreset(String presetName) {
        return UltimateZones.presetControl.createPreset(presetName, new ArrayList<Integer>(), new ArrayList<String>(),
    ...
    public void setName(String presetName) {
        if (Preset.getPreset(presetName) != null)
            return;
