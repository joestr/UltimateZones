...
public class InteractUtils {
    public static List<Material> interactRightBlockList = new ArrayList<Material>(); // Rightclick on an Block - public
                                                                                     // to allow seperate checks
    ...
    public static BlockCategory identify(Material material) {
        if (InteractUtils.checkContainer(material))
            return BlockCategory.Container;
        if (InteractUtils.checkUsableContainer(material))
            return BlockCategory.UsableContainer;
        if (InteractUtils.checkSpecialContainer(material))
            return BlockCategory.SpecialContainer;
        if (InteractUtils.checkRedstone(material))
    ...
    public static boolean isFenceGate(Material material) {
        if (material == Material.LEGACY_FENCE_GATE)
            return true;
        if (material == Material.ACACIA_FENCE_GATE)
            return true;
        if (material == Material.DARK_OAK_FENCE_GATE)
            return true;
        if (material == Material.JUNGLE_FENCE_GATE)
            return true;
        if (material == Material.BIRCH_FENCE_GATE)
            return true;
        if (material == Material.SPRUCE_FENCE_GATE)
            return true;
        return false;
    }
    ...
    private static boolean checkRedstone(Material material) {
        ...
        if (material == Material.NOTE_BLOCK)
            return true; // -> TODO As Extra Flag in next version?
        return false;
    }
    ...
    static {
        ...
        InteractUtils.interactRightBlockList.add(Material.LEGACY_BED_BLOCK);
        ...
        InteractUtils.interactRightBlockList.add(Material.LEGACY_BURNING_FURNACE);
        InteractUtils.interactRightBlockList.add(Material.LEGACY_CAKE_BLOCK);
        InteractUtils.interactRightBlockList.add(Material.CAULDRON);
        InteractUtils.interactRightBlockList.add(Material.CHEST);
        InteractUtils.interactRightBlockList.add(Material.LEGACY_COMMAND); // TODO -> possible over abort inventory open?
        InteractUtils.interactRightBlockList.add(Material.LEGACY_CROPS);
        ...
        InteractUtils.interactRightBlockList.add(Material.LEGACY_FENCE_GATE);
        ...
        InteractUtils.interactRightBlockList.add(Material.LEGACY_REDSTONE_COMPARATOR_OFF);
        InteractUtils.interactRightBlockList.add(Material.LEGACY_REDSTONE_COMPARATOR_ON);
        InteractUtils.interactRightBlockList.add(Material.LEGACY_DIODE_BLOCK_OFF);
        InteractUtils.interactRightBlockList.add(Material.LEGACY_DIODE_BLOCK_ON);
        ...
        InteractUtils.interactRightBlockList.add(Material.LEGACY_TRAP_DOOR);
        ...
        InteractUtils.interactHandList.add(Material.LEGACY_BOAT);
        InteractUtils.interactHandList.add(Material.DIAMOND_HOE);
        InteractUtils.interactHandList.add(Material.LEGACY_GOLD_HOE);
        InteractUtils.interactHandList.add(Material.LEGACY_INK_SACK);
        InteractUtils.interactHandList.add(Material.IRON_HOE);
        InteractUtils.interactHandList.add(Material.MINECART);
        InteractUtils.interactHandList.add(Material.LEGACY_COMMAND_MINECART);
        InteractUtils.interactHandList.add(Material.HOPPER_MINECART);
        InteractUtils.interactHandList.add(Material.LEGACY_EXPLOSIVE_MINECART);
        InteractUtils.interactHandList.add(Material.LEGACY_POWERED_MINECART);
        InteractUtils.interactHandList.add(Material.LEGACY_STORAGE_MINECART);
        InteractUtils.interactHandList.add(Material.STONE_HOE);
        InteractUtils.interactHandList.add(Material.WHEAT);
        InteractUtils.interactHandList.add(Material.LEGACY_WOOD_HOE);
    }
}