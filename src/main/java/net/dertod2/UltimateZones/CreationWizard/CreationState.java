...
public enum CreationState {
	/**
	 * This state is the default State directly after starting the Creation of an Zone
	 */
	NoPositionSet,
	/**
	 * When the creator of an Zone started to mark Positions this State is the current State
	 */
	PositionsSet,
	/**
