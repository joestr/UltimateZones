...
public abstract class AbstractCreation {
    ...
    protected AbstractCreation(Player zoneCreator, OfflinePlayer zoneOwner, UltimateZoneType ultimateZoneType,
    ...
    public static boolean startCreation(AbstractCreation abstractCreation) {
        if (AbstractCreation.creationList.containsKey(abstractCreation.zoneCreator.getUniqueId()))
            return false;
    ...
    public static AbstractCreation getCreation(Player player) {
        if (!AbstractCreation.creationList.containsKey(player.getUniqueId()))
            return null;
    ...
    /**
     * Creates the new Zone, to run this method the check method must be executed
     * first!
     * 
     * @return
     */
